...
public class FanoutConfig {
    ...
    public static final String TOPIC_EXCHANGE = "4140.Acc.TxnData";
    public static final String ROUTING_KEY_1 = "*.Acc.TxnData";
    public static final String ROUTING_KEY_2 = "#.Acc.TxnData";

    @Bean(name="message3")
    public Queue queueMessage() {
        return new Queue("4200.Acc.TxnData");
    }

    @Bean(name="message4")
    public Queue queueMessage1() {
        return new Queue("4300.Acc.TxnData");
    }
