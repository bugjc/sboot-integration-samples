...
//详情
function detail(id,name,productTypeId,image,price,inventoryNumber,status){
    console.log(id+","+name+","+productTypeId+","+image+","+price+","+inventoryNumber+","+status);
    reloadModelData("/product/edit","编辑产品","更新",id,name,productTypeId,image,price,inventoryNumber,status,"detail");
    $("#giveProductTypeModel").modal("show");
}
