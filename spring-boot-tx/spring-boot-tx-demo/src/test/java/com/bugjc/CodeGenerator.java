...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://ugiant.f3322.net:23306/spring-boot-tx2";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "javadev";
    ...
    private static final String AUTHOR = "aoki";//@author
    private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date());//@date

//    public static void main(String[] args) {
//        genCodeByCustomModelName("tbs_behavior","Behavior");
//        //genCodeByCustomModelName("tbs_ew_scene","Scene");
...
//    }
    ...
    public static void genController(String tableName, String modelName) {
        try {
            ...
            //cfg.getTemplate("controller-restful.ftl").process(ds, new FileWriter(file));
